...
import com.bonelf.gateway.core.shiro.filter.JwtFilter;
import com.bonelf.gateway.core.shiro.realm.ApiShiroRealm;
import com.bonelf.gateway.core.shiro.realm.CustomerRealmAuthorizer;
import com.bonelf.gateway.core.shiro.realm.ShiroRealmAuthenticator;
import com.bonelf.gateway.core.shiro.realm.SysShiroRealm;
import com.bonelf.gateway.util.RedisUtil;
...
public class ShiroConfig {
	...
	public ShiroFilterFactoryBean shiroFilter(SecurityManager securityCustomerManager) {
		...
		filterChainDefinitionMap.put(ctxPath + "/swagger-ui", "anon");
		filterChainDefinitionMap.put(ctxPath + "/swagger**/**", "anon");
		// 添加自定义过滤器为jwt
		...
		// 未授权界面返回的JSON
		shiroFilterFactoryBean.setUnauthorizedUrl(ctxPath + "/sys/error/401");
