...
import com.bonelf.auth.client.provider.ResourceProvider;
import com.bonelf.auth.domain.Resource;
import com.bonelf.auth.service.IResourceService;
import com.bonelf.auth.service.NewMvcRequestMatcher;
...
public class ResourceService implements IResourceService {
    ...
    public Map<RequestMatcher, ConfigAttribute> loadResource() {
        Set<Resource> resources = resourceProvider.resources().getResult();
