...
import com.bonelf.productservice.core.exception.ProductExceptionEnum;
import com.bonelf.productservice.domain.request.StockChangeRequest;
import com.bonelf.productservice.service.StockService;
...
public class StockServiceImpl implements StockService {
	...
	private void addStock(StockType stockType, Long id, Integer num) {
		...
		mqService.send(ChannelEnum.PRODUCT, getTagByStockType(stockType), new StockChangeRequest(id, num));
	}
